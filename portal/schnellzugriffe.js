...
const SK_KATALOG = {
  ...
  aktuelles:       ["#mehr/aktuelles", "Aktuelles", "Rechtliche Neuerungen und Versionshinweise", "aktuelles"],
  todos:           ["#mehr/todos", "To-dos", "Offene Aufgaben erledigen oder quittieren", "NAV:todos"],
  wochenbericht:   ["#mehr/logbuch?ansicht=wochenbericht", "Wochenbericht", "Was lief, was steht an", "NAV:logbuch"],
