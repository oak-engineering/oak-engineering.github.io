...
const SK_KATALOG = {
  ...
  anfragen:        ["#mehr/anfragen", "Frage an OAK engineering", "Formular mit Foto, Antwort per Mail", "brief"],
  ...
  gefahrstoffe:    ["#unterlagen/gefahrstoffe", "Gefahrstoffe", "Verzeichnis und Betriebsanweisungen", "dokument"],
